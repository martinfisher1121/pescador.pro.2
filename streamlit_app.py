...
# --- 1. SETTINGS & STYLING (Maximum Button Size) ---
st.set_page_config(page_title="Pescador Pro", page_icon="🎣")

st.markdown("""
    <style>
    /* Giant Weight Buttons */
    .stButton > button {
...
languages = {
    "English": {"venue": "Venue", "timer": "Match Timer", "start": "🚀 START", "reset": "🛑 RESET", "logger": "Weight Logger", "net": "Active Net", "total": "TOTAL", "save": "💾 SAVE", "press": "Pressure"},
    "Español": {"venue": "Escenario", "timer": "Temporizador", "start": "🚀 INICIO", "reset": "🛑 RESET", "logger": "Contador", "net": "Rejón Activo", "total": "TOTAL", "save": "💾 GUARDAR", "press": "Presión"},
    "Français": {"venue": "Lieu", "timer": "Chrono", "start": "🚀 DEBUT", "reset": "🛑 RESET", "logger": "Poids", "net": "Bourriche", "total": "TOTAL", "save": "💾 SAUVER", "press": "Pression"},
    "Deutsch": {"venue": "Gewässer", "timer": "Timer", "start": "🚀 START", "reset": "🛑 RESET", "logger": "Gewicht", "net": "Setzkescher", "total": "GESAMT", "save": "💾 SPEICHERN", "press": "Druck"}
}
...
with col_wea:
    st.write(f"☀️ 24°C | 💨 10km/h | 📉 {text['press']}: 1015hPa")
...
if st.button("🔄 Reset " + active_net, type="secondary"):
...
if st.button(text['save']):
    st.session_state.history.append({"v": venue, "w": total_all})
    st.success("OK!")
