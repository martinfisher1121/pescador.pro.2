...
st.markdown("""
    ...
    /* Style for the Reset Weight button to make it stand out */
...
languages = {
    "English": {"title": "Pescador Pro 🎣", "venue": "Venue", "weather": "Weather", "timer": "Match Timer", "start": "🚀 START", "reset_t": "🛑 RESET", "finished": "🏁 FINISHED", "logger": "Weight Logger", "add1": "➕ 1kg", "add500": "➕ 500g", "weight": "Total", "limit": "⚠️ NET LIMIT!", "notes": "Match Notes", "save": "💾 SAVE MATCH", "history": "History", "reset_w": "🔄 Reset Weight"},
    "Español": {"title": "Pescador Pro 🎣", "venue": "Escenario", "weather": "Clima", "timer": "Temporizador", "start": "🚀 EMPEZAR", "reset_t": "🛑 REINICIAR", "finished": "🏁 FINAL", "logger": "Contador de Peso", "add1": "➕ 1kg", "add500": "➕ 500g", "weight": "Total", "limit": "⚠️ ¡REJÓN LLENO!", "notes": "Notas", "save": "💾 GUARDAR", "history": "Historial", "reset_w": "🔄 Reiniciar Peso"},
    "Français": {"title": "Pescador Pro 🎣", "venue": "Lieu", "weather": "Météo", "timer": "Chrono", "start": "🚀 DÉMARRER", "reset_t": "🛑 RESET", "finished": "🏁 FINI", "logger": "Poids", "add1": "➕ 1kg", "add500": "➕ 500g", "weight": "Total", "limit": "⚠️ BOURRICHE!", "notes": "Notes", "save": "💾 SAUVER", "history": "Historique", "reset_w": "🔄 Effacer Poids"},
    "Deutsch": {"title": "Pescador Pro 🎣", "venue": "Gewässer", "weather": "Wetter", "timer": "Timer", "start": "🚀 START", "reset_t": "🛑 RESET", "finished": "🏁 ENDE", "logger": "Gewicht", "add1": "➕ 1kg", "add500": "➕ 500g", "weight": "Gesamt", "limit": "⚠️ KESCHER!", "notes": "Notizen", "save": "💾 SPEICHERN", "history": "Historie", "reset_w": "🔄 Gewicht Reset"}
}
...
# --- 5. THE LIVE TIMER (4h, 5h, 6h) ---
st.subheader(text["timer"])
match_length = st.radio("Duration", ["4h", "5h", "6h"], horizontal=True)

col_t1, col_t2 = st.columns(2)
with col_t1:
    if st.button(text["start"]):
        if "4" in match_length: hrs = 4
        elif "5" in match_length: hrs = 5
        else: hrs = 6
...
# NEW: Reset Weight Button (Specifically for the counter)
if st.button(text["reset_w"], type="secondary"):
